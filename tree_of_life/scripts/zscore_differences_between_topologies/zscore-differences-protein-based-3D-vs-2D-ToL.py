...
if __name__ == "__main__":
    ...
    dataname1 = "protein_based_2D_tree"
    ...
    edges_dict1= {
        "branch_to_eukaryota": "(Node2692*, Node2691*)",
    }
    ...
    # rearranged  protein based 3D tree
    dataname2 = "rearranged_protein_based_3D_tree"
    fasta_file = find_file_with_suffix("", ".fasta", input_dir)
    rearranged_tree_file = os.path.join(current_directory, "data/rearrangedTrees/AAhugsEtAl-treeNoBoot-3D-joined.tree")
    edges_dict2= {
        "branch_to_eukaryota": "(Node2692*, NodeInserted)",
    }
